...
VENDORS: dict[str, Vendor] = {
    v.name: v for v in (
        ...
        Vendor("nasdaq", "Nasdaq calendars", "", official=False,
               note="No key: earnings, dividends, splits and new listings, plus today's trading "
                    "halts and resumptions — read from the routes Nasdaq's own pages use. It "
        ...
        Vendor("social", "Social posts", "", official=False,
               note="No key: recent posts from a Truth Social account mirror. THE ONLY SOURCE "
                    "HERE ANYONE CAN WRITE INTO: a post is accountable to nobody and no ticker "
                    "is read out of post text, because a ticker inside a post is the author's "
                    "claim. Off until you switch it on."),
